 ...
 * @retval VECTOR_UNITIALIZED_ERROR on unitilized pointer 
 * @retval VECTOR_ALLOCATION_ERROR on realloc fail or is full and no blocksize
 */
 ...
 * @retval VECTOR_SUCCESS on success 
 * @retval VECTOR_UNITIALIZED_ERROR on unitilized pointer 
 * @retval VECTOR_INDEX_OUT_OF_BOUNDS_ERROR if the index is out of bound
 * @retval VECTOR_ALLOCATION_ERROR on realloc fail or is full and no blocksize
 *
